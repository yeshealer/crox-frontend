...
import rastaMasterChef from "config/abi/rastaMasterchef.json";
...
import grandPool from "config/abi/grandPool.json";
import vaultContract from "config/abi/vault.json";
import babyVaultContract from "config/abi/babyvpot.json";
import jackPotContract from "config/abi/jackpot.json";
...
export const useVaultContract = (address: string) => {
  const vaultContractAbi = (vaultContract as unknown) as AbiItem;
  return useContract(vaultContractAbi, address)
}

export const useBabyVaultContract = (address: string) => {
  const vaultContractAbi = (babyVaultContract as unknown) as AbiItem;
  return useContract(vaultContractAbi, address)
}

export const useJackPotContract = (address: string) => {
  const jackPotContractAbi = (jackPotContract as unknown) as AbiItem;
  return useContract(jackPotContractAbi, address)
}
...
export const useRastaMasterchef = () => {
  const abi = (rastaMasterChef as unknown) as AbiItem;
  return useContract(abi, getRastaMasterChefAddress());
};
...
export const useGrandPool = (poolAddress) => {
  const abi = (grandPool as unknown) as AbiItem;
  return useContract(abi, poolAddress[CHAIN_ID]);
};
