...
const DualFarmCard: React.FC<FarmCardProps> = ({
  farm,
  removed,
  cakePrice,
  bnbPrice,
  ...
  useEffect(() => {
    axios.get(`https://api.bscscan.com/api?module=block&action=getblockcountdown&blockno=${block}&apikey=XBAWBXPCJB2UNBI7JAAE14AANNMPMEERSC`).then(res => {
          ...
          <>
            {(farm as any).isDualFarm || (farm as any).isLPToken ? (
              <HeaderContainer>
                ...
                <EarnToken>
                  {(farm as any).isDualFarm ? (
                    ...
                    <>
                      <Flex justifyContent='center'>
                        <Text color="#2d74c4" fontSize="15px" mr='3px'>{farm.tokenSymbol}</Text>
                        <Text color="textSubtle" fontSize="15px">Earned</Text>
                      </Flex>
                      <Text color="textSubtle">{displayRewardsValue}</Text>
                    </>
              ...
              <HeaderContainer>
                ...
                {/* <MaxStake>
                  {lpLabel === "CROX" && farm.tokenSymbol !== 'PUNKS' && (
                    <Flex flexDirection='column'>
                      <Text color="textSubtle" fontSize="15px">
                        Max Stake
                      </Text>
                      <Text
                        ...
                        fontSize="15px"
                      >
                        {(farm as any).maxStakeLimit ? `${getBalanceNumber((farm as any).maxStakeLimit)} CROX` : "8000 CROX"}
                      </Text>
                    </Flex>
                  )}
                </MaxStake> */}
        ...
        {!removed ? (
          <>
            {(farm as any).isDualFarm || (farm as any).isLPToken || (farm as any).tokenSymbol === "GREM" ? (
              <Text fontSize="12px" color="textSubtle" m='5px'>
