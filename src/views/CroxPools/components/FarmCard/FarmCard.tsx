      ...
      <FCard onClick={() => setShowExpandableSection(!showExpandableSection)}>
        ...
        {removed ? (
          ...
          <HeaderContainer>
            ...
            <EarnToken>
              <Flex>
                <Text color="#2d74c4" fontSize="15px" mr='3px'>REWARDS</Text>
                <Text color="textsubtle" fontSize="15px">Earned</Text>
              </Flex>
              <Text fontSize="15px" color="textsubtle">{displayBalance}</Text>
            </EarnToken>
            <Apr>
              <Text color="textSubtle" fontSize="15px">{TranslateString(352, "APR")}</Text>
