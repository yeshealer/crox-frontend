...
const StakedDualFarmList: React.FC<StakedDualFarmListProps> = ({
    ...
    return (
        <tr>
            ...
            <td>
                <Flex justifyContent='center' alignItems='center'><Text fontSize="14px" color='white'>{getBalanceNumber(earnings[0]).toFixed(2)}</Text><Text fontSize="14px" color='#2d74c4'>CROX</Text><Text fontSize='14px' color='white'> + {getBalanceNumber(earnings[1]).toFixed(2)}</Text><Text fontSize='14px' color='#2d74c4'>{tokenSymbol}</Text></Flex>
                <Text fontSize="14px" color='white'>${(getBalanceNumber(earnings[0]) * eggPrice).toFixed(2)} + ${(getBalanceNumber(earnings[1]) * tokenPrice).toFixed(2)}</Text>
