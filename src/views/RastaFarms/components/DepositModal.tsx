...
const DepositModal: React.FC<DepositModalProps> = ({ max, onConfirm, onDismiss, tokenName = '', depositFeeBP = 0, isTokenOnly, tokenAddresses, liquidityUrlPathParts, tokenDecimals }) => {
  ...
  const [onConfirmSubmit] = useModal(<ConfirmSubmitModal bscScanAddress={bscScanAddress} value={val} tokenName={tokenName} />)
